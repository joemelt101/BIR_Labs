...
if("TRUE" STREQUAL "TRUE")
  set(irobot_SOURCE_PREFIX /home/joemelt101/catkin_ws/src/irobot)
  set(irobot_DEVEL_PREFIX /home/joemelt101/catkin_ws/devel)
  set(irobot_INSTALL_PREFIX "")
  set(irobot_PREFIX ${irobot_DEVEL_PREFIX})
else()
  set(irobot_SOURCE_PREFIX "")
  set(irobot_DEVEL_PREFIX "")
  set(irobot_INSTALL_PREFIX /home/joemelt101/catkin_ws/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'irobot' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'joemelt101 <joemelt101@todo.todo>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'irobot' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/joemelt101/catkin_ws/src/irobot/${idir}'.  Ask the maintainer 'joemelt101 <joemelt101@todo.todo>' to fix it.")
    endif()
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${irobot_dep}_FOUND)
      find_package(${irobot_dep} REQUIRED)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${irobot_dep} REQUIRED ${depend_list})
  endif()
